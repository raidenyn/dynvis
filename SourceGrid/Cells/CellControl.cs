...
namespace SourceGrid.Cells
{
    ...
    /// </summary>
    [Obsolete(
        "I will soon remove this class. If you need to add a user control to the grid I suggest to manually add or remove it using the Grid.LinkedControls collection."
        )]
    public class CellControl : Cell
    {
        private readonly Control mControl;

        private readonly LinkedControlScrollMode mScrollMode = LinkedControlScrollMode.BasedOnPosition;
        private readonly bool mUseCellBorder = true;
        ...
        public override void BindToGrid(Grid p_grid, Position p_Position)
        {
            ...
            var linkedValue = new LinkedControlValue(mControl, Range.Start);
