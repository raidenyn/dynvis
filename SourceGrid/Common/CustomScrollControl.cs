...
namespace SourceGrid
{
    ...
    public abstract class CustomScrollControl : Panel
    {
        ...
        protected virtual void CreateDockControls()
        {
            ...
            panelDockBottom.Dock = DockStyle.Bottom;

            mBottomRightPanel.Dock = DockStyle.Right;

            mHScrollBar.Dock = DockStyle.Fill;
            ...
            mHScrollBar.ValueChanged += HScroll_Change;
            mVScrollBar.ValueChanged += VScroll_Change;
        ...
        /// </summary>
        private readonly Panel mBottomRightPanel = new Panel();

        private readonly HScrollBar mHScrollBar = new HScrollBar();
        private readonly VScrollBar mVScrollBar = new VScrollBar();

        /// <summary>
        /// Internal panel that contains hScrollBar and mBottomRightPanel
        /// </summary>
        private readonly Panel panelDockBottom = new Panel();
        ...
        protected virtual void PrepareScrollBars(bool showHScroll, bool showVScroll)
        {
            if (showHScroll != HScrollBarVisible)
            {
                if (showHScroll)
                {
                    panelDockBottom.Height = SystemInformation.HorizontalScrollBarHeight;
        ...
        {
            if (value)
                mHScrollBar.Height = SystemInformation.HorizontalScrollBarHeight;
            else
        ...
        private int mHorizontalPage;

        private int mVerticalPage;
        ...
        private int m_OldHScrollValue;
        private int m_OldVScrollValue;
        ...
        {
            if (VScrollBarVisible)
                mVScrollBar.Value = Math.Min(mVScrollBar.Value + mVScrollBar.LargeChange,
                                             mVScrollBar.Maximum - mVScrollBar.LargeChange);
        }
        ...
        {
            if (HScrollBarVisible)
                mHScrollBar.Value = Math.Min(mHScrollBar.Value + mHScrollBar.LargeChange,
                                             mHScrollBar.Maximum - mHScrollBar.LargeChange);
        }
