...
namespace SourceGrid
{
    ...
    public struct Range
    {
        ...
        {
            var l_List = new PositionCollection();
        ...
        public RangeRegion Exclude(Range range)
        {
            ...
            else
            {
                ...
                if (Start.Row < intersection.Start.Row &&
                    Start.Column < intersection.Start.Column)
                    excluded.Add(new Range(Start.Row, Start.Column, intersection.Start.Row - 1,
                                           intersection.Start.Column - 1));

                //Top
                if (Start.Row < intersection.Start.Row)
                    excluded.Add(new Range(Start.Row, intersection.Start.Column, intersection.Start.Row - 1,
                                           intersection.End.Column));

                //Top Right
                if (Start.Row < intersection.Start.Row &&
                    End.Column > intersection.End.Column)
                    excluded.Add(new Range(Start.Row, intersection.End.Column + 1, intersection.Start.Row - 1,
                                           End.Column));
                ...
                if (Start.Column < intersection.Start.Column)
                    excluded.Add(new Range(intersection.Start.Row, Start.Column, intersection.End.Row,
                                           intersection.Start.Column - 1));

                //Right
                if (End.Column > intersection.End.Column)
                    excluded.Add(new Range(intersection.Start.Row, intersection.End.Column + 1, intersection.End.Row,
                                           End.Column));

                //--------

                //Bottom Left
                if (End.Row > intersection.End.Row &&
                    Start.Column < intersection.Start.Column)
                    excluded.Add(new Range(intersection.End.Row + 1, Start.Column, End.Row,
                                           intersection.Start.Column - 1));

                //Bottom
                if (End.Row > intersection.End.Row)
                    excluded.Add(new Range(intersection.End.Row + 1, intersection.Start.Column, End.Row,
                                           intersection.End.Column));

                //Bottom Right
                if (End.Row > intersection.End.Row &&
                    End.Column > intersection.End.Column)
                    excluded.Add(new Range(intersection.End.Row + 1, intersection.End.Column + 1, End.Row, End.Column));
            }
