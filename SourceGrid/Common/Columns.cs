...
namespace SourceGrid
{
    ...
    public abstract class ColumnsBase
    {
        ...
        public int MeasureColumnWidth(int column, bool useRowHeight, int StartRow, int EndRow)
        {
            ...
            {
                ICellVirtual cell = Grid.GetCell(r, column);
                if (cell != null)
                {
                    var cellPosition = new Position(r, column);
                    ...
                    var cellContext = new CellContext(Grid, cellPosition, cell);
    ...
    {
        private readonly List<ColumnInfo> m_List = new List<ColumnInfo>();
        ...
        public void RemoveRange(int p_StartIndex, int p_Count)
        {
            ...
            var eventArgs = new IndexRangeEventArgs(p_StartIndex, p_Count);
