...
namespace SourceGrid
{
    ...
    public class RangeRegion : ICollection<Range>
    {
        ...
        public virtual int[] GetRowsIndex()
        {
            ...
            for (int iRange = 0; iRange < Count; iRange++)
            {
            ...
            var ret = new int[indexList.Count];
        ...
        {
            var excludedRange = new RangeRegion(this);
        ...
        {
            var region = new RangeRegion(this);
        ...
        private bool InternalAdd(RangeRegion pRange)
        {
            ...
            else
            {
                ...
                var e = new RangeRegionCancelEventArgs(pRange);
