...
using CheckBox=SourceGrid.Cells.Views.CheckBox;
using Utilities=DevAge.Windows.Forms.Utilities;
...
namespace SourceGrid.Exporter
{
    ...
    public class HTML
    {
        ...
        public virtual string[] EmbeddedImagesPath
        {
            get
            {
                var l_Images = new string[m_EmbeddedImagesPath.Count];
        ...
        public virtual string ExportImage(System.Drawing.Image p_Image)
        {
            ...
            {
                l_FileName = Path.Combine(m_ImageFullPath, Path.GetTempFileName() + ".jpg");
                p_Image.Save(l_FileName, ImageFormat.Jpeg);
        ...
        {
            if (border is RectangleBorder)
            {
                var brd = (RectangleBorder) border;
        ...
        protected virtual void ExportHTMLCell(CellContext context, XmlTextWriter writer)
        {
            ...
            else
            {
                ...
                if (context.Cell.View is Cell)
                {
                    var viewCell = (Cell) context.Cell.View;
                    ...
                    //alignment
                    writer.WriteAttributeString("align",
                                                Utilities.ContentToHorizontalAlignment(viewCell.TextAlignment).ToString()
                                                    .ToLower());
                ...
                if (context.Cell.View is CheckBox)
                {
                    var checkModel = (ICheckBox) context.Cell.Model.FindModel(typeof (ICheckBox));
                    CheckBoxStatus status = checkModel.GetCheckBoxStatus(context);
                ...
                if (context.Cell.View is Cell)
                {
                    ...
                    var imgModel = (IImage) context.Cell.Model.FindModel(typeof (IImage));
                    if (imgModel != null)
                    ...
                    if (img != null)
                    {
                        ...
                        writer.WriteAttributeString("align",
                                                    Utilities.ContentToHorizontalAlignment(viewCell.ImageAlignment).
                                                        ToString().ToLower());
