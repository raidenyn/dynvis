...
namespace Tao.Platform.Windows
{
    ...
    public static class Kernel
    {
        ...
        public struct SYSTEM_INFO_UNION
        {
            ...
            ///     </para>
            /// </summary>
            [FieldOffset(0)] public int OemId;
            ...
            ///     </para>
            /// </summary>
            [FieldOffset(0)] public short ProcessorArchitecture;
        ...
        [DllImport(KERNEL_NATIVE_LIBRARY, CallingConvention = CALLING_CONVENTION, SetLastError = true),
        ...
        [DllImport(KERNEL_NATIVE_LIBRARY, CallingConvention = CALLING_CONVENTION, CharSet = CharSet.Auto,
        ...
        [DllImport(KERNEL_NATIVE_LIBRARY, CallingConvention = CALLING_CONVENTION, CharSet = CharSet.Ansi,
            SetLastError = true), SuppressUnmanagedCodeSecurity]
        ...
        [DllImport(KERNEL_NATIVE_LIBRARY, CallingConvention = CALLING_CONVENTION, SetLastError = true),
         SuppressUnmanagedCodeSecurity]
        public static extern bool GetProcessWorkingSetSize(IntPtr process, out int minimumWorkingSetSize,
        ...
        /// <seealso cref="QueryPerformanceFrequency" />
        [DllImport(KERNEL_NATIVE_LIBRARY, CallingConvention = CALLING_CONVENTION, EntryPoint = "QueryPerformanceCounter"
            ), SuppressUnmanagedCodeSecurity]
        ...
        [DllImport(KERNEL_NATIVE_LIBRARY, CallingConvention = CALLING_CONVENTION, SetLastError = true),
         SuppressUnmanagedCodeSecurity]
        public static extern bool SetProcessWorkingSetSize(IntPtr process, int minimumWorkingSetSize,
