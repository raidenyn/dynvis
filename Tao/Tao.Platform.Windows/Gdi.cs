...
namespace Tao.Platform.Windows
{
    ...
    public static class Gdi
    {
        ...
        /// 
        /// </summary>
        [DllImport(GDI_NATIVE_LIBRARY, EntryPoint = "SetPixelFormat", SetLastError = true), CLSCompliant(false),
        ...
        /// <param name="deviceContext"></param>
        /// <returns></returns>
        [DllImport(GDI_NATIVE_LIBRARY, CallingConvention = CALLING_CONVENTION, EntryPoint = "SwapBuffers"),
         SuppressUnmanagedCodeSecurity]
        ...
        /// <returns></returns>
        [DllImport(GDI_NATIVE_LIBRARY, SetLastError = true), SuppressUnmanagedCodeSecurity]
        public static extern IntPtr CreateFont(int height, int width, int escapement, int orientation, int weight,
                                               bool italic, bool underline, bool strikeOut, int charSet,
