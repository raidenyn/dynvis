...
namespace DevAge.Windows.Forms
{
	...
	/// </summary>
	public class PositionRecorderIsolatedStorage : IO.IsolatedStorage.IsolatedStorageSettingVersionBase
	{
		...
		public virtual void Save(Control p_Control)
		{
			...
			{
				System.Windows.Forms.Form l_Form = ((Form)p_Control);
		...
		public virtual void Load(Control p_Control)
		{
			...
			if ( p_Control is Form && 
				((Form)p_Control).WindowState == FormWindowState.Minimized )
			{
