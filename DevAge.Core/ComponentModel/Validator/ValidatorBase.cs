...
namespace DevAge.ComponentModel.Validator
{
    ...
    public class ValidatorBase : ComponentLight, IValidator
    {
        ...
        protected virtual void OnLoadingValueType()
        {
            if (ValueType != null)
            {
                if (ValueType.IsValueType)
                {
                    ...
                    if (ValueType.IsEnum)
                    {
                        FieldInfo[] fields = ValueType.GetFields(BindingFlags.Public | BindingFlags.Static);
        ...
        public object ObjectToValue(object p_Object)
        {
            ...
            var l_Converting = new ConvertingObjectEventArgs(p_Object, destinationType);
        ...
        public object ValueToObject(object p_Value, Type p_ReturnObjectType)
        {
            ...
            var l_Converting = new ConvertingObjectEventArgs(p_Value, p_ReturnObjectType);
        ...
        {
            var l_Converting = new ConvertingObjectEventArgs(p_Value, typeof (string));
        ...
        public bool IsValidValue(object p_Value)
        {
            try
            {
                ...
                {
                    var l_Max = (IComparable) m_MaximumValue;
                ...
                {
                    var l_Min = (IComparable) m_MinimumValue;
        ...
        private ICollection m_StandardValues;
        ...
        public virtual object StandardValueAtIndex(int p_Index)
        {
            ...
            var l_List = m_StandardValues as IList;
            if (l_List != null)
