...
namespace DevAge.Patterns
{
    ...
    public abstract class ActivityBase : IActivity
    {
        ...
        private readonly ActivityCollection mSubActivities;

        /// <summary>
        /// Initially set to signaled=true=completed, nonsignaled=false=notcompleted,
        /// </summary>
        private readonly ManualResetEvent mWaitHandle = new ManualResetEvent(true);
        ...
        private int mSubActivitiesTimeOut = Timeout.Infinite;
    ...
    {
        private readonly EmptyDelegate asyncDelegate;

        public AsynchronousActivity()
        {
            asyncDelegate = OnAsyncWork;
        }
