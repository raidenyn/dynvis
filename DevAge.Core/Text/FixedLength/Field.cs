...
namespace DevAge.Text.FixedLength
{
    ...
    public class Field : IField
    {
        ...
        ///<summary>
        ///</summary>
        ///<exception cref="InvalidFieldLengthException"></exception>
        public int Length
        {
            get { return mLength; }
            set
        ...
        public virtual string RegularExpressionPattern
        {
            get
            {
                ...
                return string.Format(pattern, Name, Length);
            }
        }
        ...
        public virtual string ValueToString(object val)
        {
            try
            {
                string tmp = Validator.ValueToString(val) ?? string.Empty;
                ...
                if (tmp.Length < Length)
                {
                    ...
                    else
                    {
                        if (Validator.ValueType == typeof (string))
                            ...
                            tmp = tmp.PadLeft(Length, '0');
                                //N.B. Questo sarebbe da cambiare nel caso in cui l'int abbia il segno!!
