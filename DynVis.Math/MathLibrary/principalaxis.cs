...
namespace DynVis.Math
{
    class principalaxis
    {
        ...
        *************************************************************************/
        public static double principalaxisminimize(
            ref double[] x,
            double t0,
            double h0,
            ...
            int maxStep)
        {
            ...
            large = 1 / small;
            vlarge = 1 / vsmall;
            m2 = M.Sqrt(AP.Math.MachineEpsilon);
            m4 = M.Sqrt(m2);
            scbd = 1;
            illc = false;
            ktm = 1;
            ...
            {
                counterstep++;
                if (counterstep > maxStep) break;
                sf = d[1];
                d[1] = 0;
                s = 0;
                value = fx;
                temparrayelement = d[1];
                directionalminimize(n, 1, 2, ref temparrayelement, ref s, ref value, false, ref x, ref t, AP.Math.MachineEpsilon, h, f);
                ...
                for (k = 2; k <= n; k++)
                {
                    ...
                    while (true)
                    {
                        ...
                        if (illc)
                        {
                            for (i = 1; i <= n; i++)
                            {
                                s = (0.1 * ldt + t2 * M.Pow(10, kt)) * (AP.Math.RandomReal() - 0.5);
                                z[i] = s;
                                for (j = 1; j <= n; j++)
                                {
                                    x[j] = x[j] + s * v[j, i];
                        ...
                        for (k2 = k; k2 <= n; k2++)
                        {
                            ...
                            directionalminimize(n, k2, 2, ref temparrayelement, ref s, ref value, false, ref x, ref t, AP.Math.MachineEpsilon, h, f);
                        ...
                        if (illc | df >= M.Abs(100 * AP.Math.MachineEpsilon * fx))
                        {
                            break;
                        }
                        illc = true;
                    ...
                    if (lds > small)
                    {
                        ...
                        directionalminimize(n, k, 4, ref temparrayelement, ref lds, ref value, true, ref x, ref t, AP.Math.MachineEpsilon, h, f);
                ...
                quadsearch(n, ref x, ref t, AP.Math.MachineEpsilon, h, f);
                dn = 0;
                for (i = 1; i <= n; i++)
                {
                    d[i] = 1 / M.Sqrt(d[i]);
                ...
                while (true)
                {
                    ...
                    if (flag1 != 120)
                    {
                        ...
                        for (i = l; i <= k; i++)
                        {
                            ...
                            if (M.Abs(af) < M.Abs(g))
                            {
                                h = M.Abs(g) * M.Sqrt(1 + AP.Math.Sqr(af / g));
                            }
                            else
                            {
                                if (af == 0)
                                ...
                                {
                                    h = M.Abs(af) * M.Sqrt(1 + AP.Math.Sqr(g / af));
                                }
                            }
                            q[i] = h;
                            if (h == 0)
                    ...
                    if (lp1 <= k)
                    {
                        for (i = lp1; i <= k; i++)
                        {
                            ...
                            if (M.Abs(af) < M.Abs(h))
                            {
                                z = M.Abs(h) * M.Sqrt(1 + AP.Math.Sqr(af / h));
                            }
                            else
                            {
                                if (af == 0)
                                ...
                                {
                                    z = M.Abs(af) * M.Sqrt(1 + AP.Math.Sqr(h / af));
                                }
                            }
                            e[i - 1] = z;
                            if (z == 0)
        ...
        *************************************************************************/
            ...
            Func<double[], double> f)
        {
            ...
            t2 = m4 * M.Sqrt(M.Abs(fx) / temp + s * ldt) + m2 * ldt;
            s = m4 * s + t;
            if (dz & t2 > s)
            {
                t2 = s;
        ...
        *************************************************************************/
            ...
            Func<double[], double> f)
        {
            ...
            {
                value = qf1;
                directionalminimize(n, 0, 2, ref s, ref l, ref value, true, ref x, ref t, machep, h, f);
                qa = l * (l - qd1) / (qd0 * (qd0 + qd1));
                qb = (l + qd0) * (qd1 - l) / (qd0 * qd1);
                qc = l * (l + qd0) / (qd1 * (qd0 + qd1));
            }
