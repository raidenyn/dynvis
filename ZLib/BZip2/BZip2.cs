...
namespace ICSharpCode.SharpZipLib.BZip2
{
	...
	public static class BZip2
	{
        ...
        /// Options of streams
        ///</summary>
        public enum Options {CloseStreams, NotCloseStream}
        ...
        public static void Decompress(Stream inStream, Stream outStream, Options options)
        {
            if (inStream == null)
            {
            ...
            {
                if (options == Options.CloseStreams)
                {
                    outStream.Close();
                }
            }
        ...
        {
            Decompress(inStream, outStream, Options.CloseStreams);
        }
